...
func init() {
	...
	registerCloudControl("AWS::Lightsail::Alarm")
	registerCloudControl("AWS::Lightsail::Bucket")
	registerCloudControl("AWS::Lightsail::Certificate")
	registerCloudControl("AWS::Lightsail::Container")
	registerCloudControl("AWS::Lightsail::Database")
	registerCloudControl("AWS::Lightsail::Distribution")
	registerCloudControl("AWS::Lightsail::LoadBalancerTlsCertificate")
